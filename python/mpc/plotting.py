...
plt.plot(states_mean[:, 0], states_mean[:, 1], color="g", linewidth=2, label=r"$\mu=6$")
...
ax1.plot(time, states_mean[:, 0], color="g", label=r"$\mu=6$")
ax2.plot(time, states_mean[:, 1], color="g", label=r"$\mu=6$")
ax3.plot(time, states_mean[:, 2], color="g", label=r"$\mu=6$")
...
ax1.plot(time, controls_mean[:, 0], color="g", label=r"$\mu=6$")
ax2.plot(time, controls_mean[:, 1], color="g", label=r"$\mu=6$")
